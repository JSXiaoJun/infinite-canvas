export default {
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", sizes: { landscape: "横屏", portrait: "竖屏", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    canvas: {
        ...
        composer: { title: "组装提示词", description: "已连接素材会自动发送，@ 可在提示词中插入素材标签", placeholder: "输入提示词，或按 @ 插入已连接素材", imagePreview: "引用图片预览", resources: { image: "图片{{index}}", video: "视频{{index}}", audio: "音频{{index}}", text: "文本{{index}}" } },
        controls: { ratio: "比例", duplicate: "复制", clearResult: "清空节点结果", delete: "删除", images: "{{count}} 张", generations: "{{count}} 次", reasoning: "推理" },
