export default {
    ...
    canvas: {
        ...
        composer: { title: "Compose prompt", description: "Connected assets are sent automatically; use @ to insert asset labels", placeholder: "Enter a prompt, or use @ to insert a connected asset", imagePreview: "Referenced image preview", resources: { image: "Image {{index}}", video: "Video {{index}}", audio: "Audio {{index}}", text: "Text {{index}}" } },
        controls: { ratio: "Ratio", duplicate: "Duplicate", clearResult: "Clear node result", delete: "Delete", images: "{{count}} images", generations: "{{count}} runs", reasoning: "Reasoning" },
